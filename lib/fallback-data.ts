...
export const fallbackStaff: StaffMember[] = [
  ...
  },
  {
    ...
    role: 'Associate Pastor & Youth',
    roleAr: 'القس المساعد وشبيبة',
    initials: 'WN',
    bio: 'Wissam grew up in the church and felt called to ministry at age 19. He leads our thriving youth ministry and serves as associate pastor, overseeing discipleship, Bible study, and community outreach. He is completing his theological studies and is passionate about reaching the next generation of Lebanese Christians with deep, joyful faith.',
    bioAr: 'نشأ وسام في الكنيسة وشعر بالدعوة للخدمة في سن ١٩. يقود خدمة الشبيبة المزدهرة لدينا ويعمل قسيساً مساعداً مشرفاً على التتلمذ ودراسة الكتاب المقدس والتواصل المجتمعي. يكمل دراساته اللاهوتية وشغوف بالوصول إلى الجيل القادم من المسيحيين اللبنانيين بإيمان عميق وفرح.',
  },
  {
    _id: 'st3',
    name: 'Rick Warner',
    nameAr: 'ريك وارنر',
    role: 'Guest Pastor & Missions',
    roleAr: 'القس الضيف والإرساليات',
    initials: 'RW',
    bio: 'Rick serves as a missions pastor and regular visiting preacher at Bikfayah Baptist. Originally from the United States, Rick has lived and ministered in Lebanon for over 15 years alongside his wife Sarah. He oversees our international partnerships, missions prayer network, and has a passion for Reformed theology and cross-cultural church planting throughout the Middle East.',
    bioAr: 'يخدم ريك قسيساً للإرساليات وكارزاً زائراً منتظماً في كنيسة بكفيّا المعمدانية. أصله من الولايات المتحدة الأمريكية، عاش وخدم في لبنان لأكثر من ١٥ عاماً مع زوجته سارة. يشرف على شراكاتنا الدولية وشبكة صلاة الإرساليات ولديه شغف باللاهوت الإصلاحي وزرع الكنائس بين الثقافات في جميع أنحاء الشرق الأوسط.',
  },
];
